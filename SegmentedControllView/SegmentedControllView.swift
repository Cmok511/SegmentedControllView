...
protocol SegmentedControllViewDataSourse: AnyObject {
    func segmentedlCount(_ segmentedControllView: SegmentedControllView) -> Int
    func segmentedTitle(_ segmentedControllView: SegmentedControllView, indexPath: IndexPath) -> String
}

protocol SegmentedControllViewDelegate: AnyObject {
    func selectedIndex(_ segmentedControllView: SegmentedControllView, index: IndexPath)
}

protocol SegmentedControllVieProtocol {
...
public class SegmentedControllView: UIControl, SegmentedControllVieProtocol {
   
     weak var dataSourse: SegmentedControllViewDataSourse? {
        didSet {
            setupView()
        }
    }
    weak var delegate: SegmentedControllViewDelegate?
